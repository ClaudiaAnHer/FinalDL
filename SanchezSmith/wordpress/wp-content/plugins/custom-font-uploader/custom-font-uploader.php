...
foreach ($cons as $con => $value) define($con, $value);
...
function custom_font_admin_page_link($links) {
    $cfup_links = array(
        '<a href="' . admin_url('admin.php?page=custom-font-uploader-settings') . '">'.__( 'Settings', CFUP_TEXT_DOMAIN ).'</a>',
        '<a href="https://wbcomdesigns.com/contact/" target="_blank">'.__( 'Support', CFUP_TEXT_DOMAIN ).'</a>'
    );
